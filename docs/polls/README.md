...
UI, metadata and print header. Poll pages add report downloads, research metadata,
methodology and news release; only memos have endorsement/critique controls.
...
York Factory's Polls editor stores analysis markdown and PDF, bilingual crosstabs
...
import it through York Factory's Polls screen and add the written analysis and PDFs.
