    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="border-t border-border-light pt-3">
          <p className="type-label text-accent">Success Story: SR&amp;ED Reforms</p>
        </div>
        ...
        <Link
          ...
          className="border border-border-light p-3 flex flex-col gap-1.5 group hover:bg-border-light/20 transition-colors"
        >
          <h4 className="type-caption font-sans font-medium tracking-tight group-hover:text-accent transition-colors" style={{ lineHeight: 1.1 }}>
