...
export function getAlignmentColor(
  ...
  switch (alignment) {
    case "aligns":
      return "text-pine-700 bg-pine-50 border-pine-200";
    case "conflicts":
      return "text-auburn-700 bg-auburn-50 border-auburn-200";
    case "neutral":
      return "text-charcoal-700 bg-steel-50 border-steel-200";
    default:
      return "text-charcoal-700 bg-steel-50 border-steel-200";
  }
}
