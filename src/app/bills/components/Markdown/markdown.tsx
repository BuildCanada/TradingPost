    ...
    <ReactMarkdown
      ...
      components={{
        ...
        code: ({ children }: { children: React.ReactNode }) => (
          <code className="bg-linen-200 px-1 py-0.5 text-xs font-mono">
            {children}
          </code>
        ),
        pre: ({ children }: { children: React.ReactNode }) => (
          <pre className="bg-linen-200 p-3 mb-3 overflow-x-auto text-xs">
            {children}
          </pre>
        ),
        blockquote: ({ children }: { children: React.ReactNode }) => (
          <blockquote className="border-l-4 border-border-light pl-4 mb-3 italic">
            {children}
          </blockquote>
        ),
      }}
