      ...
      <div className="mx-[10px] my-[10px] border border-border-light bg-bg overflow-x-clip">
        ...
        <section className="grid grid-cols-2 border-b-2 border-dark">
          <Link
            ...
            className="group px-6 md:px-14 py-7 border-r border-border-light transition-colors hover:bg-linen-200/60"
          >
          ...
          <Link
            ...
            className="group px-6 md:px-14 py-7 text-right transition-colors hover:bg-linen-200/60"
          >
